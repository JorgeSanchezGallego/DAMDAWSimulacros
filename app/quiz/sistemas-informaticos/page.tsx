...
const questions: Question[] = [
  {
    ...
    options: ['Únicamente el hardware', 'Solo el software del ordenador', 'Hardware, software y usuarios que gestionan la información', 'Programas de ofimática y sistemas operativos'],
    correctAnswer: 2
  },
  {
    question: 'Cuando hablamos de la CPU, memoria RAM y disco duro, ¿a qué parte del sistema informático nos referimos?',
  ...
  {
    question: '¿Qué componente del ordenador se encarga de coordinar y controlar todas las operaciones que realiza la CPU?',
  ...
  },
  {
    ...
    options: ['La CPU ejecuta instrucciones, mientras que la RAM almacena datos temporalmente', 'Ambas tienen la misma función', 'La RAM controla los dispositivos externos', 'La CPU solo almacena datos'],
    correctAnswer: 0
  },
  {
    question: '¿Qué tipo de memoria se borra al apagar el equipo y se utiliza para almacenar datos de trabajo de la CPU?',
  ...
  },
  {
    ...
    options: ['Traducir código fuente a binario', 'Ejecutar programas y gestionar los recursos del sistema', 'Controlar el flujo eléctrico de la placa base', 'Crear aplicaciones de usuario'],
    correctAnswer: 1
  },
  {
    question: '¿Qué característica define a un sistema operativo multitarea?',
    options: ['Funciona únicamente sin interfaz gráfica', 'Requiere hardware especializado', 'Solo admite un usuario por sesión', 'Permite ejecutar más de un proceso al mismo tiempo'],
    correctAnswer: 3
  },
  {
  ...
  {
    question: 'Si formateas un disco desde Windows 11 con la configuración predeterminada, ¿qué sistema de archivos se aplica?',
    options: ['APFS', 'EXT4', 'NTFS', 'exFAT'],
    correctAnswer: 2
  },
  {
    question: '¿Qué función realiza un hipervisor en un entorno virtualizado?',
    options: ['Supervisa las conexiones de red', 'Administra usuarios y contraseñas', 'Gestiona las máquinas virtuales y sus recursos', 'Protege el sistema mediante cifrado'],
    correctAnswer: 2
  },
  {
  ...
  {
    question: '¿Qué aplicación se utiliza en entornos formativos para simular varios sistemas operativos en un solo equipo?',
    options: ['Scratch', 'VirtualBox', 'NetBeans', 'Notepad++'],
    correctAnswer: 1
  },
  {
    question: '¿Qué beneficio ofrece una máquina virtual respecto a un sistema operativo instalado directamente en el hardware?',
    options: ['Permite probar configuraciones sin modificar el sistema principal', 'Aumenta la velocidad de la CPU', 'Consume menos energía eléctrica', 'Mejora la resolución de pantalla'],
    correctAnswer: 0
  },
  {
  ...
  {
    question: 'Si un usuario desea crear una carpeta llamada "documentos" en su directorio personal, ¿qué comando debe utilizar?',
  ...
  {
    question: 'Si un usuario quiere cambiar la configuración del sistema, como la red o los programas instalados, ¿dónde puede encontrar el Panel de control?',
    options: ['En el menú del antivirus', 'En la BIOS del equipo', 'En el explorador de archivos, dentro de C:\\Windows', 'En el menú Inicio o buscador de Windows'],
    correctAnswer: 3
  },
  {
    question: 'Si un administrador desea añadir un nuevo usuario en Windows 10, ¿qué apartado debe abrir?',
    options: ['Panel de control → Programas', 'BIOS → Usuarios del sistema', 'Configuración → Cuentas → Familia y otros usuarios', 'Carpeta de sistema C:\\Windows'],
    correctAnswer: 2
  },
  {
    question: 'Si un usuario quiere leer el contenido de un archivo llamado "notas.txt" desde la terminal, ¿qué comando debe usar?',
  ...
  {
    question: 'Si un administrador necesita actualizar la contraseña de un usuario en Linux, ¿qué instrucción debe utilizar?',
    options: ['password', 'passwd', 'chpass', 'sudoedit'],
    correctAnswer: 1
  },
  {
    question: 'Si un administrador necesita consultar las contraseñas cifradas de los usuarios del sistema, ¿en qué archivo debería buscarlas?',
    options: ['/etc/users', '/etc/shadow', '/etc/group', '/etc/sudoers'],
    correctAnswer: 1
  },
  {
    question: '¿Qué fichero de configuración contiene los nombres de usuario, UID, GID y el directorio personal de cada cuenta?',
  ...
  {
    question: '¿Qué comando del sistema Linux permite visualizar el contenido de un directorio, mostrando archivos y subcarpetas?',
  ...
  {
    question: 'Si un usuario quiere comprobar qué programas están activos desde la línea de comandos de Windows, ¿qué instrucción debe escribir?',
  ...
  },
  {
    ...
    options: ['Para crear imágenes del sistema operativo', 'Para instalar Docker en diferentes sistemas', 'Para editar el contenido de una imagen', 'Para gestionar y orquestar varios contenedores definidos en un mismo archivo'],
    correctAnswer: 3
  },
  {
    question: '¿Qué protocolo utiliza un servidor para ofrecer direcciones IP dinámicas a los clientes que las solicitan?',
    options: ['DHCP', 'DNS', 'TCP', 'UDP'],
    correctAnswer: 0
  },
  {
    question: '¿Qué protocolo se encarga de traducir nombres de dominio como "www.google.com" a direcciones IP?',
    options: ['DHCP', 'IP', 'TCP', 'DNS'],
    correctAnswer: 3
  },
  {
    question: 'Un contenedor Docker se detuvo tras su ejecución. ¿Qué instrucción debe usarse para volver a iniciarlo sin crear uno nuevo?',
  ...
  {
    question: 'Si un usuario quiere consultar qué imágenes de Docker tiene descargadas en su equipo, ¿qué instrucción debe usar?',
  ...
  },
  {
    ...
    options: ['Docker comparte el kernel del sistema base, mientras que las máquinas virtuales emulan un sistema completo.', 'Docker ejecuta su propio kernel independiente.', 'Las máquinas virtuales no utilizan recursos del hardware físico.', 'No hay ninguna diferencia técnica.'],
    correctAnswer: 0
  }
]
